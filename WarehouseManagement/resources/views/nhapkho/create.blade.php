        ...
        <div class="container">
            <div class="nk-content-inner">
                <div class="nk-content-body">
                    ...
                    <div class="nk-block">
                    <form action="{{ route('api.nhap-kho.store') }}" method="POST" id="form-create">
                    @csrf
                    @method('post')
                    <div class="row g-gs">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input style="width:100%" type="text" class="form-control" id="Ma_Phieu_Nhap" value="{{ $Ma_Phieu_Nhap }}" disabled>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input style="width:100%" type="date" class="form-control" name="Ngay_Nhap" value="{{ old('Ngay_Nhap') }}" required>
                                                        </div>
                                                    </div>
                                                    </div>
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label for="Ma_NCC" class="form-label">Nhà cung cấp</label>
                                                        <div class="form-control-wrap">
                                                            <select class="js-select" data-search="true" name="Ma_NCC" id="Ma_NCC" required>
                                        ...
                                        <table id="item-table" class="table">
                                            <thead class="table-light">
                                                <tr>
                                                    ...
                                                    <th class="tb-col">Số lượng nhập</th>
                                                    <th class="tb-col">Giá nhập</th>
                                                    <th class="tb-col">NSX</th>
                                                    <th class="tb-col">Bảo quản(tháng)</th>
                                            ...
                                            <tbody id="tb-container">
                                                <tr class="item-row">
                                                    ...
                                                    <td class="tb-col">
                                                        <div class="form-control-wrap">
                                                            <input style="width:100%" type="number" class="form-control" name="Gia_Nhap[]" required />
                                                        </div>
                                                    </td>
                                                    <td class="tb-col">
                                                        <div class="form-control-wrap">
                                                            <input style="width:100%" type="date" class="form-control" name="Ngay_San_Xuat[]" required />
                                                        </div>
                                                    </td>
                                                    <td class="tb-col">
                                                        <div class="form-control-wrap">
                                                            <input style="width:100%" type="number" class="form-control" name="Thoi_Gian_Bao_Quan[]" required />
                                                        </div>
                                                    </td>
